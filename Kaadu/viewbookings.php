...
<header>
    ...
    <h1>Hi <b><?php echo htmlspecialchars($_SESSION["username"]) ?></b>,These are the bookings by the tourists.</h1>
    </div>
...
. $row["name"]. "</td><td>" . $row["count"] . "</td><td>" . $row["room"] . "</td><td>&nbsp;" . $row["nights"] . "</td><td>&nbsp;" . $row["date"] . "</td></tr>";
}
echo "</table>";
} else { echo "0 results"; }
$conn->close();
