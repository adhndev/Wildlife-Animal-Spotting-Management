...
<header>
    ...
    <h1>Hi <b><?php echo htmlspecialchars($_SESSION["username"]) ?></b>,These are the registered naturalists.</h1>
    </div>
    <div>
...
$sql = "SELECT username,created_at FROM naturalist";
...
?>
    ...
    <br><br><div><a href="deletenaturalist.php" class="btn btn-danger">Delete an account</a></div>   
