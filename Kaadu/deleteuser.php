...
<header>
    <div class="container">
        ...
        <nav>
            <ul>
            <li class="left"><a href="viewusers.php">Go Back</a></li>
...
?>
    ...
    <br><br>
    <div><form method="post" action="deleteuserprocess.php">Username: <input type="text" name="name" placeholder="Enter the username you want to delete"><br><br>
